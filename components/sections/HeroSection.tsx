    ...
    <section className="">
      <div className="container">
        <div className="flex flex-col">
          <h1 className="text-foreground text-pretty text-2xl md:text-[32px] lg:text-[40px] xl:text-6xl font-medium sm:font-semibold leading-tight pb-16 md:pb-24 pt-36 lg:pt-44">
            Hi, I'm Nikola. Full stack developer with 3 years building apps for
            agencies and SaaS products. JavaScript, TypeScript, frontend
            architecture, and API integration.
          </h1>
          <div>
            <div className="flex max-[510px]:flex-col max-[510px]:items-start items-center justify-between gap-y-16 gap-x-10 pb-6 border-b border-border">
            ...
            <div className="flex items-center justify-end pt-8 max-[510px]:pt-6 max-[510px]:justify-start">
              <p className="text-foreground text-base md:text-lg font-light">
                <span className="text-muted-foreground pr-4">Local Time:</span>
                <LocalTimeComponent theme="light" />
              </p>
            </div>
          </div>
        </div>
